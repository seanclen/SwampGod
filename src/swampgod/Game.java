...
public class Game extends Observable implements java.io.Serializable{
    ...
    /**
     * Takes in a GameState and updates the game state based on the parameter.
     * Will notify the game's observers that the state has changed.
     * @param gameState - The state of the game to update to.
     */
    public void updateGameState(GameState gameState) {
        ...
        if(!this.gameState.equals(gameState)) {
            ...
            if (gameState.equals(GameState.TUTORIAL_STATE)){
            	initialize();
            	tutorialStage = 1;
            	isTutorial = true;
            }
            ...
            {
                System.out.println("updateGameState" + gameState);
                initialize();
